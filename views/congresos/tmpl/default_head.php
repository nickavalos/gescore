...
<tr>
    <th width="1%">
        <input type="checkbox" name="toggle" value="" onclick="checkAll(<?php echo count($this->congresos); ?>);" />
    </th>
    <th width=""> <?php echo JText::_('Nombre'); ?> </th>
    <th width="10%"> <?php echo JText::_('Acrónimo'); ?> </th>
