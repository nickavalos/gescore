...
$this->document->addScript(DIR_SCRIPTS_GESCORE . 'congresoNewEdicion.js');
...
$this->numeroEdicionMostrada = $this->ultimaEdicionCongreso->max + 1;
$this->edicion = new stdClass();
$this->edicion->orden = 1;
$this->edicion->lugar = "";
$this->edicion->linkEdicion = "";
$this->edicion->limRecepcion = "";
$this->edicion->fechaDefinitiva = "";
$this->edicion->fechaInicio = "";
$this->edicion->fechaFin = "";
...
<form action="<?php echo JRoute::_('index.php?option=com_gestorcore&controller=congreso&task=infoCongreso&id=' . $this->nomCongreso); ?>" method="post" name="adminForm" id="form_gestionEdicion">
