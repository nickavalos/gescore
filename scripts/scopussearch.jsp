...
//<!-- Set the vars that sciverse.js will need -->
var sciverseURL="http://searchapi.scopus.com/";
//var sciverseURL="http://api.elsevier.com/content/search/";
...
function sciverseListRenderer(){
	...
	this._authkeywords		="doi";
	this._authkeywordsName	="Authkeywords";
	...
	var orderedFields=[this._authkeywords, this._title,this._doctype,this._citedbycount,this._inwardurl,this._sourcetitle,this._issn,this._vol,this._issue,this._page,this._pubdate,this._eid,this._scp,this._doi,this._firstAuth,this._affiliations,this._abstract,this._authlist];
...
function sciverseBackend(){
	...
	//this._sciverseURL = sciverseURL+"index:SCIDIR";
